...
arma::Col<double> EmInitilizationMlpack::get_priors() { return priors; }

std::vector<arma::Col<double>> EmInitilizationMlpack::get_mu() { return mu; }

std::vector<arma::Mat<double>> EmInitilizationMlpack::get_sigma() { return sigma; }
